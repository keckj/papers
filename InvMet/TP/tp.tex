...
$\colbox{\J(\u_0) = \dfrac{1}{2}\displaystyle \int_0^T\norm{\utrue(t)-\u(t)}^2 \dt}$ where $\u$ is the solution of (1) with initial condition $\u_0$.
...
= \dfrac{1}{2\alpha}\displaystyle \int_0^T \left[ \norm{\utrue(t) - \ut(t)}^2 - \norm{\utrue(t)-\u(t)}^2 \right ] \dt
\vskip 0.2cm
\hskip 3.75cm
=\dfrac{1}{2\alpha}\displaystyle \int_0^T \left[ \norm{\utrue(t) - \u(t) - \alpha\ \ub(t)}^2 - \norm{\utrue(t)-\u(t)}^2 \right ] \dt
\vskip 0.2cm
\hskip 3.75cm
=\dfrac{1}{2\alpha}\displaystyle \int_0^T \left[ \alpha^2\ \norm{\ub(t)}^2 + 2 \langle \utrue(t) - \u(t), \alpha\ \ub(t) \rangle\right] \dt
\vskip 0.2cm
\hskip 3.75cm
=\dfrac{1}{2}\displaystyle \int_0^T \left[ \alpha\ \norm{\ub(t)}^2 + 2 \langle \u(t) - \u(t), \ub(t) \rangle\right] \dt
\vskip 0.2cm
\hskip 3.75cm
$
...
\colbox{
d\left(\J(\u_0)\right)(\delta \u_0) 
= \displaystyle \int_0^T \left( \utrue(t) - \u(t) \right)^T \uh(t) \dt
}
\end{equation}
$$
